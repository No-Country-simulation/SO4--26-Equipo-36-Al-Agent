# POLÍTICAS COMERCIALES, ESTRUCTURA DE COSTOS Y LÍMITES OPERATIVOS DE NEXO PAY
...
Con el objetivo de salvaguardar los fondos de los clientes y mitigar los riesgos de fraude digital por suplantación, Nexo Pay establece techos operativos diarios para la salida de capitales.

* **Límite Diario General:** El monto máximo autorizado para transferir desde una cuenta Nexo Pay hacia cuentas de terceros (ya sean CBU bancarias o CVU virtuales de otras entidades) es de **$500.000 pesos argentinos (ARS)** por día calendario. Este límite se restablece automáticamente a las 00:00 horas de cada día.  
* **Transferencias entre Cuentas Nexo Pay:** Los movimientos de fondos realizados entre cuentas propias del mismo titular o hacia otros usuarios registrados dentro de la comunidad Nexo Pay están completamente liberados y no computan para el límite diario de $500.000 ARS.  
* **Frases de Activación en el Buscador Semántico:** El modelo de embeddings asociará consultas como *"¿cuánto es lo máximo que puedo transferir por día?"*, *"límite de envío de plata en Nexo Pay"*, o *"no me deja mandar más de 500 mil pesos"* de forma directa a este apartado.
...
* **Mecanismo de Autogestión:** La ampliación no puede ser otorgada de forma directa por el chat de texto del asistente virtual por razones de seguridad. El bot redirigirá al usuario a la sección de configuración de seguridad de la aplicación de Nexo Pay.  
...
Nexo Pay está adherida al sistema de pagos del ecosistema financiero nacional, garantizando que la enorme mayoría de las operaciones se procesen en tiempo real.
...
* **Alertas de Red Externa:** Si una transferencia inmediata sufre demoras, el asistente virtual informará al usuario que la demora no responde a las reglas de negocio de Nexo Pay, sino a congestiones temporales en la cámara compensadora central (COELSA) o en la entidad receptora de los fondos.
...
Nexo Pay ofrece dos segmentos de cuentas comerciales para sus usuarios individuales, cuyas reglas de costos y beneficios se detallan a continuación:
...
Nexo Pay permite a sus clientes retirar dinero en efectivo de sus cuentas utilizando su tarjeta de débito física en cualquier terminal del país.
...
Cuando un usuario utiliza su tarjeta Nexo Pay (física o virtual) para adquirir bienes o servicios en el extranjero o en plataformas digitales radicadas fuera del territorio nacional (ej: servicios de streaming, tiendas internacionales, licencias de software), se aplican las siguientes reglas comerciales:

* **Tasa de Comisión Administrativa:** Nexo Pay aplica un cargo del **3% sobre el monto neto de la transacción** en concepto de gastos de procesamiento internacional. Esta comisión se calcula sobre el tipo de cambio oficial mayorista del día de la operación.  
* **Percepción de Impuestos Locales:** El asistente de IA debe informar con precisión que, de acuerdo con las normativas fiscales vigentes del país, las compras internacionales se verán gravadas con los impuestos nacionales correspondientes (Impuesto PAIS, Percepciones de Ganancias y Bienes Personales). Estos cargos tributarios se desglosan en el comprobante comercial de forma separada a la comisión de Nexo Pay.